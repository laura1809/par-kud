    ...
    return (
      ...
      <h1 className="my-6 text-xl font-bold leading-none tracking-tight text-gray-900 md:text-3xl lg:text-5xl dark:text-dark text-center ">Sucursal</h1>
            <div className="mx-6 my-2 p-5 bg-white max-w-[500px] min-w-[500px] mx-auto border border-gray-200 rounded-lg shadow ">
              ...
              <p className="mb-1 text-sm font-normal text-black"><span className="font-semibold">Hora de apertura:</span> 7:00 a.m
                <button
                    className="bg-blue flex justify-center items-center mx-auto text-white font-bold px-4 py-3 shadow rounded-md "
              ...
              <p className="mb-1 text-sm font-normal text-black"><span className="font-semibold">SUV:</span> 70 minuto 
                <button
                    className="bg-yellow flex justify-center items-center mx-auto text-black font-bold px-4 py-3 shadow rounded-md "
                    onClick={editDataComp}

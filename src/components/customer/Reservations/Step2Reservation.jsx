const Step2Reservation = ({enableDiv}) => {
  return (
              ...
              <div className="max-w-md mx-auto">
                ...
                <div className="divide-y divide-gray-200">
                  ...
                  <div class="pt-4 flex items-center space-x-4">
                    ...
                    <button class="bg-yellow flex justify-center items-center w-full text-black font-bold px-4 py-3 shadow rounded-md"  onClick={enableDiv('form3')}>Buscar</button>
                  </div>
                </div>
              </div>
            </div>

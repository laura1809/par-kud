  ...
  return (
    <main className="container flex justify-center mx-auto mt-2 mb-0">
      <article id="userSign" className={`w-1/4  absolute rounded-t-2xl shadow-xl rounded-b-xl bg-blue`}>
        <img src="https://res.cloudinary.com/dn1k0drir/image/upload/v1685304390/sale_1_vzaywe.png" alt="Logo de la app" id="appLogo" width="290" height="230"
          className="mx-auto" />
        ...
        <form action="" id="userSignIn-form" className="mt-0">
          ...
          <div className="flex justify-center mt-5">
            <ReCAPTCHA sitekey={key} onChange={onChange} ref={captcha} className="scale-95" />
          </div>
